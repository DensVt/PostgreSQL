...
- Please download a materials/rush01_model.sql with Database Model here and apply the script to your database (you can use command line with psql or just run it through any IDE, for example DataGrip from JetBrains or pgAdmin from PostgreSQL community). 
- Please take a look at the Logical View of our Database Model. 


## Exercise 00 - Classical DWH
k at the data sources and first logical data layer (ODS - Operational Data Store) in the DWH.
